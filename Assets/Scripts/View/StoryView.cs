...
public class StoryView : BaseView
{
    ...
    private string[] str = new string[]{"\u3000\u3000上古之时，天地灵脉贯通，灵植漫山、矿石蕴聚奇光。彼时灵茶坊、炼器铺遍布街巷，连寻常百姓都能寻得灵材，灵艺技艺代代相传，一派繁荣祥和。然而灵族为了争夺灵脉核心，引入了妖力并使其扩散，导致无数灵植、矿石受到妖力影响，化形四处巡游，甚至变异为具有攻击性的巨型灵体。灵材的异变让灵艺传承陷入绝境，灵植与矿石愈发难寻难取，导致世间灵茶、灵器的制作技艺几近失传。",
        "\u3000\u3000就在灵艺即将断绝之际，一柄沉睡千年的镇妖剑苏醒。此剑天生克制妖力，能驱散灵植、矿石体内的妖气，使其恢复纯净本质。千百年后，你被镇妖剑选中，成为新一代镇妖剑主人。身负驱散妖力、复苏灵艺的使命，踏入这片灵材难寻、妖力弥漫的妖剑世界。",
